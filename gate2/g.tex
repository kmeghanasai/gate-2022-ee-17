...
\begin{align}
T_1 (s)&=\frac{s-1}{s+1}\label{eq:gate2022eee17eq1}\\
T_2 (s)&=\frac{1-s}{1+s}\label{eq:gate2022eee17eq2}\\
...
\angle T_1(j\omega)&=180\degree - \tan^{-1}(\omega)-\tan^{-1}(\omega)\\
&=180\degree - 2\tan^{-1}(\omega)
\end{align}
At $\omega=\infty$,
\begin{align}
...
Using equation \eqref{eq:gate2022eee17eq3}\\
\begin{align}
T_2 (j \omega)&=\frac{1-j \omega }{1+j \omega}\\
\angle T_2(j\omega)&=- \tan^{-1}(\omega)-\tan^{-1}(\omega)\\
&=- 2\tan^{-1}(\omega)
\end{align}
At $\omega=\infty$,
\begin{align}
